...
import 'package:flutter_supabase/screens/Dashboard/QueryScreen/view_more.dart';

class SmartLearnCard extends StatelessWidget {
  final String query, experienceLevel, description;
  final List<String> tags;
  final int budget;
  const SmartLearnCard(
      {super.key,
      required this.query,
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(query, style: CustomDesign().text20700DarkBlue),
